...
class TipoDocumento(Documento):
  ...
  ListaProjeto = ['ProjetoDeLei', 'ProjetoDeLeiComplementar', 'ProjetosDeResolucao', 'ProjetoDeDecreto', 'PropostaDeEmendaALeiOrganica']
  ListaPropositura = ['Requerimento', 'Indicacao', 'MocaoDeAplausos','MocaoDePesar','MocaoDeRepudio']
  ListaDocPerma = ['Lei', 'LeiComplementar', 'Resolucao', 'Decreto', 'EmendaALeiOrganica']
